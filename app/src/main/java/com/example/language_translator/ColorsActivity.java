...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Gray","ग्रे रंग",R.drawable.color_gray,R.raw.color_gray));
        ...
        words.add(new Word("Yellow","पीला",R.drawable.color_mustard_yellow,R.raw.color_yellow));
